...
const StyledButton = styled.button`
    ...
    box-shadow: 0 .2em 0 ${props => props.theme.keysBackgroundShadow};
    border: none;
    ...
    &.red {
        ...
        box-shadow: 0 .2em 0 ${props => props.theme.equalKeyBackgroundShadow};

    }
    &.desaturated {
        background-color: ${props => props.theme.delKeyBackground};
        color: ${props => props.theme.font};
        box-shadow: 0 .2em 0 ${props => props.theme.delKeyBackgroundShadow};
